...
GROQ_API_KEY = os.environ.get('GROQ_API_KEY', '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')
# APPLICATIONS 
...
USE_I18N = True
USE_TZ = True
IP_GEO_API_URL = os.environ.get('IP_GEO_API_URL', 'https://ipapi.co')
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", EMAIL_HOST_USER or "no-reply@newgen.local")
